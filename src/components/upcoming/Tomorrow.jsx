...
const Tomorrow = ({ forecast }) => {
  ...
  const dateStr = forecast.list[9].dt_txt;
    ...
    <div className="p-4">
      ...
      <div className="text-5xl mt-8 mb-5 text-center">
        <span className="font-bold">
          {Math.floor(forecast.list[9].main.temp)}
        </span>
      ...
      <div className=" m-auto pt-4 grid gap-3 place-items-center">
        <div className="m-auto flex justify-center items-center">
          <img
            src={`https://openweathermap.org/img/wn/${forecast.list[9].weather[0].icon}.png`}
            alt=""
          />
          <p>{forecast.list[9].weather[0].main}</p>
        </div>
        ...
        <div className="m-auto mt-2 flex justify-center items-center">
          ...
          <p>
            <span className="font-semibold">{forecast.list[9].wind.speed}</span>{" "}
            km/h
          </p>
        </div>
        <div className="m-auto mt-2 flex justify-center items-center">
